    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Reported', 'Reported'), ('Assigned', 'Assigned'), ('In Remediation', 'In Remediation'), ('Remediated', 'Remediated'), ('In Verification', 'In Verification'), ('Verified', 'Verified'), ('Closed', 'Closed')], max_length=20)),
            ],
            options={
                'db_table': 'status',
            },
        ...
        migrations.CreateModel(
            name='MissionHistory',
            fields=[
                ('mission_history_id', models.AutoField(primary_key=True, serialize=False)),
